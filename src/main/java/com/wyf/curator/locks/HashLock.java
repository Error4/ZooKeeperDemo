...
public class HashLock<T> {
	...
	//分段锁
	private final SegmentLock<T> segmentLock = new SegmentLock<T>();
	private final ConcurrentMap<T, LockInfo> lockMap = new ConcurrentHashMap<T, LockInfo>();
